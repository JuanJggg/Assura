  ...
  return (
    ...
    <div className="bg-white relative w-full h-full flex justify-center items-center">
      ...
      <div className="relative z-10 mt-16 p-10 px-23 bg-white rounded-xl shadow-2xl border border-gray-300">
        ...
        {/* Botones de login */}
        <button onClick={onLogin} className="w-full bg-red-600 text-white font-semibold py-2 rounded-lg shadow-md hover:bg-red-500 transition cursor-pointer"
        >
          Iniciar Sesión
        </button>
        ...
        <div className="mt-4 text-sm text-center text-gray-600 flex justify-center space-x-2">
          <p onClick={() => navigate("/Register")} className="text-red-600 font-semibold hover:underline cursor-pointer"
          >
