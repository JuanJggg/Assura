          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div>
                {[
                  ...
                  <div key={i} className={`flex items-center justify-between py-4 border-b border-black/20 ${i === 2 ? 'border-0' : ''}`}>
                    <div className="flex items-center gap-4">
                      {/* Avatar con inicial */}
                      <div className="w-10 h-10 bg-indigo-500 text-white rounded-full flex items-center justify-center text-lg font-semibold uppercase">
                        {msg.name.charAt(0)}
                      </div>
                      <div>
                ...
                <button className="mt-4 text-white bg-indigo-500 hover:bg-indigo-600 px-4 py-2 rounded-full text-sm">
                  Load more
                </button>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md space-y-6">
              ...
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center justify-center">
                  ...
                  <button className="mt-2 text-white bg-indigo-500 hover:bg-indigo-600 px-3 py-1 rounded-full text-sm">
                    Following you
                  </button>
                </div>
              ))}
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              {tareasIzquierda.map((tarea) => (
                <div key={tarea.id} className="grid grid-cols-12 gap-2 py-3 border-b border-gray-100 items-center text-sm">
                  ...
                  <div className="col-span-2">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${tarea.priority === 'High' ? 'bg-red-100 text-red-600' :
