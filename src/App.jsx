...
function App() {
    ...
    const tareasIzquierda = [
        {id: 1, assigned: "Noticias de Assura", name: "Philip Smead", date: "April, 25", priority: "New"},
        {id: 2, assigned: "Themesdesign", name: "Brent Shipley", date: "April, 28", priority: "High"},
        {id: 3, assigned: "Noticias de Assura", name: "Kevin Ashley", date: "June, 12", priority: "Medium"},
        {id: 4, assigned: "Themesdesign", name: "Martin Whitmer", date: "June, 28", priority: "Medium"},
    ];

    // Datos para el segundo componente de tareas pendientes
    const tareasDerecha = [
        {id: 1, assigned: "Noticias de Assura", name: "Enrique Peters", date: "July, 15", priority: "High"},
        {id: 2, assigned: "Themesdesign", name: "Richard Schnell", date: "July, 30", priority: "New"},
        {id: 3, assigned: "Noticias de Assura", name: "Dennis Jackson", date: "August, 08", priority: "Medium"},
        {id: 4, assigned: "Noticias de Assura", name: "Carlos Rodrigues", date: "August, 23", priority: "Low"},
    ];
                ...
                <main className="flex-1 bg-gray-100 p-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        {asesores.map((asesor, index) => (
                            ...
                            >
                                <div
                                    className="w-16 h-16 rounded-full bg-gray-200 flex items-center justify-center mb-2">
                                ...
                                <h3 className="text-lg font-semibold text-gray-700">{asesor.asesor}</h3>
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            <div
                                className="flex justify-center items-center space-x-8 border-b border-black/20 pb-4 mb-6 text-center text-gray-400 font-semibold text-sm select-none">
                                <div>
                                    <p className="text-cyan-500 font-bold text-lg">{comentario.length}</p>
                                    <p>Comentarios</p>
                                </div>
                            </div>
                            ...
                            <div>
                                {comentario.slice(0, 3).map((msg, i) => (
                                    <div key={i}
                                         className={`flex items-center justify-between py-4 border-b border-black/20 ${i === 2 ? 'border-0' : ''}`}>
                                        ...
                                        <span className="text-xs text-gray-400">{formatDate(new Date(msg.fecha))}</span>
                                    </div>
                                ))}
                            ...
                            <div className="space-y-4 text-sm">
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        <span
                                            className="text-cyan-500 hover:underline cursor-pointer">Forget UX Rowland</span>
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        <span
                                            className="text-cyan-500 hover:underline cursor-pointer">Designer Alex</span>
                                    </p>
                                </div>
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        ...
                                        <span
                                            className="text-cyan-500 hover:underline cursor-pointer">Developer Moreno</span>
                                    </p>
                                </div>
                                <div>
                            ...
                            {[
                                {
                                    ...
                                    icon: (
                                        <path
                                            d="M22 12a10 10 0 10-11.78 9.88v-7H8v-3h2.22V9.5c0-2.2 1.3-3.42 3.3-3.42.96 0 1.97.17 1.97.17v2.17H14.9c-1.1 0-1.44.69-1.44 1.4V12h2.45l-.39 3h-2.06v7A10 10 0 0022 12z"/>
                                    )
                                },
                                {
                                    name: "X",
                                ...
                                <div key={i} className="flex flex-col items-center text-center justify-center">
                                    <svg className={`w-8 h-8 ${platform.color} mb-2`} fill="currentColor"
                                         viewBox="0 0 24 24">
                                        {platform.icon}
                                    </svg>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-md">
                            ...
                            {tareasIzquierda.map((tarea) => (
                                <div key={tarea.id}
                                    ...
                                    <div className="col-span-3 text-gray-700">{tarea.assigned}</div>
